...
const Footer = () => {
  ...
  return (
    <footer className="text-white bg-primary">
      <div className="py-5 text-center text-white bg-warning">
        <Container className="d-md-flex justify-content-between align-items-center">
          <div>
            <h2 className="pb-4 mb-4 mb-md-0 text-primary fw-semibold">
              <span
                className="px-3 py-1 rounded-5 fw-bold"
      ...
      <Container className="pt-5 pb-4">
        ...
        <Row className="pt-4 text-center">
          <Col md={4}>
            <span>© 2024 ProShop. All rights reserved.</span>
          </Col>
          <Col md={4}>
