  ...
  return (
    ...
    >
      <Form.Control
        ...
        className="text-white border-2 mr-sm-2 ml-sm-5 ms-4 bg-primary search-input fw-medium"
      ></Form.Control>
      <Button
        type="submit"
        style={{
        ...
        className="px-3 py-0 m-0 text-black shadow-none h-100 fw-medium text-primary"
      >
        Search
      </Button>
    </Form>
